#include "bumperbot_controller/differential_inverse_controller.hpp"
...
SimpleController::SimpleController(const std::string &name) : Node(name),left_wheel_previous_position_(0.0),right_wheel_previous_position_(0.0),x_(0.0),y_(0.0),theta_(0.0){
    ...
    inv_speed_conversion_ = speed_conversion_.inverse();
...
void SimpleController::velCallback(const geometry_msgs::msg::TwistStamped &msg){
    ...
    Eigen::Vector2d wheel_speed = inv_speed_conversion_ * robot_speed;
