...
class NoisyController(Node):
    ...
    def jointCallback(self, msg):
        wheel_encoder_left = msg.position[1] + np.random.normal(0.0, 0.005)
        wheel_encoder_right = msg.position[0] + np.random.normal(0.0, 0.005)
        dp_left = wheel_encoder_left - self.left_wheel_previous_position_
        dp_right = wheel_encoder_right - self.right_wheel_previous_position_
